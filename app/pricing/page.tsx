...
const tiers = [
  ...
  },
  {
    ...
    description: 'Perfect for students with verification',
    icon: GraduationCap,
    features: [
      '20 GB storage (2 months only)',
  ...
  },
  {
    ...
    href: '/pricing?checkout=business',
    popular: true,
  },
  {
    name: 'Enterprise',
    price: 'Custom',
    period: 'starting at $10/mo',
